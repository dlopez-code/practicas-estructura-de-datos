...
void PilaLibreria::mostrar(){
    ...
    cout<<"Elementos: "<<endl;
    while(!cop.empty()){ //mientras la pila no está vacía muestra el ultimo elemento y luego lo borra
        cout<<cop.top()<<" "; //hasta que no quede ningun elemento y se muestren todos
        cop.pop();
    }
    cout << endl;
}
